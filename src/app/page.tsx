            ...
            <div className="backdrop-blur-xl bg-gradient-to-br from-white/15 to-gray-100/15 dark:from-gray-900/30 dark:to-gray-800/30 rounded-3xl shadow-2xl border border-gray-200/30 dark:border-gray-700/30 p-10">
              ...
              <div className="mb-8">
                ...
                <div className="flex justify-center items-center gap-8">
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gray-400/20 to-gray-600/20 dark:from-gray-500/20 dark:to-gray-300/20 border border-gray-300/40 dark:border-gray-600/40 flex items-center justify-center backdrop-blur-sm transition-all duration-300 group-hover:scale-110 group-hover:bg-gradient-to-br group-hover:from-gray-300/30 group-hover:to-gray-500/30 dark:group-hover:from-gray-400/30 dark:group-hover:to-gray-200/30 group-hover:border-gray-400/60 dark:group-hover:border-gray-500/60">
                      <Globe className="w-4 h-4 text-gray-600 dark:text-gray-300 transition-colors duration-300 group-hover:text-gray-800 dark:group-hover:text-white" />
                    </div>
                    <span className="text-xs text-gray-600 dark:text-gray-300 font-light transition-colors duration-300 group-hover:text-gray-800 dark:group-hover:text-white">Portfolio</span>
                  </a>
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gray-400/20 to-gray-600/20 dark:from-gray-500/20 dark:to-gray-300/20 border border-gray-300/40 dark:border-gray-600/40 flex items-center justify-center backdrop-blur-sm transition-all duration-300 group-hover:scale-110 group-hover:bg-gradient-to-br group-hover:from-gray-300/30 group-hover:to-gray-500/30 dark:group-hover:from-gray-400/30 dark:group-hover:to-gray-200/30 group-hover:border-gray-400/60 dark:group-hover:border-gray-500/60">
                      <svg className="w-4 h-4 text-gray-600 dark:text-gray-300 transition-colors duration-300 group-hover:text-gray-800 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-xs text-gray-600 dark:text-gray-300 font-light transition-colors duration-300 group-hover:text-gray-800 dark:group-hover:text-white">Instagram</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-600 dark:text-gray-300 font-light transition-colors duration-300 group-hover:text-gray-800 dark:group-hover:text-white">Twitter</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-600 dark:text-gray-300 font-light transition-colors duration-300 group-hover:text-gray-800 dark:group-hover:text-white">LinkedIn</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-600 dark:text-gray-300 font-light transition-colors duration-300 group-hover:text-gray-800 dark:group-hover:text-white">GitHub</span>
                  </a>
                </div>
              </div>
